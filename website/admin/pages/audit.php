...
echo '<div class="phead"><div><h1>' . h(t('Audit Log')) . '</h1><p>' . h(t('sub_audit')) . '</p></div></div>';
echo '<div class="card" style="margin-top:16px"><table class="tbl"><thead><tr><th>When (IST)</th><th>User</th><th>Role</th><th>Action</th><th>Detail</th><th>IP</th></tr></thead><tbody>';
foreach ($rows as $r) {
    ...
    echo '<tr><td class="mut">' . h(dt((int)$r['ts'], 'd M Y · H:i')) . '</td><td><b>' . h($r['user']) . '</b></td>'
