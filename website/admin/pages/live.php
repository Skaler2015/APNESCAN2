...
echo '<div class="card" style="margin-top:18px"><div class="pad" style="padding-bottom:6px"><div class="ctitle">' . icon('pulse') . 'Live event feed</div><div class="csub">Newest actions across all installs</div></div>'
   . '<table class="tbl"><thead><tr><th>When (UTC)</th><th>Feature</th><th>Version</th><th>Install</th></tr></thead><tbody id="lvFeed"><tr><td colspan="4" class="empty">Connecting…</td></tr></tbody></table></div>';
?>
<script>
(function(){
